...
MODEL.Esc.v1.dbi = MODEL.F;

% Mantener la tasa invariable
MODEL.Esc.v1.dbi.RS(MODEL.DATES.pred_start) = MODEL.Esc.v1.dbi.RS(MODEL.DATES.hist_end);
...
MODEL.Esc.v1.planSim = endogenize(MODEL.Esc.v1.planSim,{'SHK_RS'},MODEL.DATES.pred_start); 
% Variable a exogenizar (Anclaje)
MODEL.Esc.v1.planSim = exogenize(MODEL.Esc.v1.planSim,{'RS'},MODEL.DATES.pred_start);
