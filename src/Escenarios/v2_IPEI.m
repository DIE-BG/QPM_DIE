...
alt2 = load(fullfile('data', 'corrimientos',MODEL.CORR_DATE,...
            'v1', sprintf('MODEL-%s.mat',MODEL.CORR_DATE)));

alt2 = alt2.MODEL.PostProc.v0.l_sa;
...
MODEL.Esc.v2.dbi.L_CPI_RW(MODEL.DATES.E1_dates) = alt2.ln_ipei_sa(MODEL.DATES.E1_dates);
...
MODEL.Esc.v2.planSim = endogenize(MODEL.Esc.v2.planSim,{'SHK_DLA_CPI_RW'},MODEL.DATES.E1_dates); 
% Variable a exogenizar (Anclaje)
MODEL.Esc.v2.planSim = exogenize(MODEL.Esc.v2.planSim,{'L_CPI_RW'},MODEL.DATES.E1_dates);
