        ...
        for i = 1:length(toplot)
            ...
            if i == 1 || i >= 3
                ...
                plot(rng{1}:params.EndDatePlot{1},...
                    MODEL.Esc.(params.Esc_add{1}).(toplot{i}),...
                    'Marker', '.',...
                    'MarkerSize', 7,...
                    'LineWidth', 1.25,...
                    'Color', 'b');
                ...
                % Escenario
                plot(rng{1}:params.EndDatePlot{1},...
                    full_data_add.Esc.(params.Esc_add{1}).(toplot{i}),...
                    'Marker', '.',...
                    'MarkerSize', 7,...
                    'LineWidth', 1.25,...
                    'Color', 'r');
                ...
                %titulos
                title(MODEL.Esc.(params.Esc_add{1}).(toplot{i}).Comment{1});
            ...
            elseif i == 2
                ...
                %Corrimiento actual
                plot(rng{1}:params.EndDatePlot{1},...
                    exp(MODEL.Esc.(params.Esc_add{1}).(toplot{i})/100),...
                    'Marker', '.',...
                    'MarkerSize', 7,...
                    'LineWidth', 1.25,...
                    'Color', 'b');
                ...
                %Escenario
                plot(rng{1}:params.EndDatePlot{1},...
                    exp(full_data_add.Esc.(params.Esc_add{1}).(toplot{i})/100),...
                    'Marker', '.',...
                    'MarkerSize', 7,...
                    'LineWidth', 1.25,...
                    'Color', 'r');
